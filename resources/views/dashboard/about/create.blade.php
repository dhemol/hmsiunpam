...
@section('title', 'Tambah Data About | HMSI UNPAM')
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <h1>Create Data About</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ url('/dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{ url('/dashboard/about') }}">Data About</a></div>
                <div class="breadcrumb-item">Create Data About</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Create Data About</h2>
            <p class="section-lead">
                On this page you can create a new Data About and fill in all fields.
            </p>
                        ...
                        <div class="card-body">
                            <form action="{{ url('/dashboard/about') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary" type="submit">Create Data About</button>
                                    </div>
                                </div>
                            </form>
                        </div>
