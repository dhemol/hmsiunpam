...
@section('content')
    ...
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit Data Blog</h2>
            <p class="section-lead">
                On this page you can edit a Data Blog and fill in all fields.
            </p>
                        ...
                        <div class="card-body">
                            <form action="/dashboard/post/{{ $post->slug }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        @if ($post->image)
                                            <img src="{{ asset('storage/' . $post->image) }}"
                                                alt="{{ $post->title }} " class="img-fluid mb-3 col-sm-5 d-block"
                                                id="img-preview">
                                        @else
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary" type="submit">Update Data Blog</button>
                                    </div>
                                </div>
                            </form>
                        </div>
